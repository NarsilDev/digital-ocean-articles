...
12. Copy the resulting output (starting with **apiVersion**) and then create a new file for the user, for example: `
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5NDk1ODc0NywxNTEzNjQ3MjIsMjgzMD
