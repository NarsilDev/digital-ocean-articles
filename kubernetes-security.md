...
As expected, you won't get any response either. Cancel the ping request pressing **Ctrl+C** and then close `default-test` session pressing **Ctrl+D**. Keep `dmz-test` session active.
